...
export default {    
    ...
    methods: {
        getEnvs() {
          var dataURL = 'http://localhost:8086/snowden/envs';
          var self = this  
          console.log(dataURL);   
        ...
        getFromAPI(start_date, end_date) {                   
          ...
          var myInit = { method: 'GET',
               headers: myHeaders,
               cache: 'default' };
          var dataURL = 'http://localhost:8086/snowden/byRange/' + start_date + endDateURL
          var self = this  
          console.log(dataURL)
        ...
        upsert(jose){
          ...
          var dataURL = 'http://localhost:8086/snowden/results/' + jose.item.id
          console.log(dataURL)
          fetch(dataURL)
        ...
        runSnowden() {
          var snowdenURL = 'http://localhost:8086/snowden/env/' + this.env            
